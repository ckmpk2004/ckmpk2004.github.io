...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.addGame = function (gameInformation) {
    ...
    DataService.prototype.modifyGame = function (gameInformation) {
        this.httpOptions2.headers = this.httpOptions2.headers
            .set('Accept', 'application/json')
            .set('Content-type', 'application/json')
            .set('auth-token', this.getToken())
    ...
    DataService.prototype.deleteGame = function (gameName) {
        this.httpOptions2.headers = this.httpOptions2.headers
            .set('Accept', 'application/json')
            .set('Content-type', 'application/json')
            .set('auth-token', this.getToken())
    ...
    DataService.prototype.readyToPassGameData = function (name, description, price) {
        this._nameStore = name;
        this._descriptionStore = description;
        this._priceStore = price;
    };
    //GetPassingData for modification form
    DataService.prototype.getGameData = function () {
...
var AddComponent = /** @class */ (function () {
    function AddComponent(_data, _router) {
        this._data = _data;
        this._router = _router;
        this.newGameData = {};
    ...
    AddComponent.prototype.addGame = function () {
        var _this = this;
        console.log(this.newGameData);
        this._data.addGame(this.newGameData).subscribe(function (res) {
            console.log(res);
    ...
    AddComponent.prototype.BackToPrePage = function () {
...
var GamesComponent = /** @class */ (function () {
    function GamesComponent(data, _router) {
        this.data = data;
        this._router = _router;
    ...
    GamesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getGames().subscribe(function (data) {
            _this.games = data;
            console.log(_this.games);
        });
    };
    //Route to add game page
    GamesComponent.prototype.toAddGamePage = function () {
        this._router.navigate(['./games/add']);
    };
    //Route to modify page
    GamesComponent.prototype.toModifyGamePage = function () {
        this._router.navigate(['./games/modify']);
    };
    //Pass original game data to modify form
    GamesComponent.prototype.passDataToForm = function (name, description, price) {
        this.data.readyToPassGameData(name, description, price);
    };
    GamesComponent.prototype.modification = function (name, description, price) {
        this.toModifyGamePage();
        this.passDataToForm(name, description, price);
    };
    //Delete game from database
    GamesComponent.prototype.deleteGame = function (gameName) {
        var _this = this;
        console.log(gameName);
        this.data.deleteGame(gameName).subscribe(function (res) {
            console.log(res);
            _this.refreshPage();
    ...
    GamesComponent.prototype.refreshPage = function () {
...
var ModifyComponent = /** @class */ (function () {
    function ModifyComponent(_data, _router) {
        this._data = _data;
        this._router = _router;
    ...
    ModifyComponent.prototype.ngOnInit = function () {
        var passedData = this._data.getGameData();
    ...
    ModifyComponent.prototype.ModifyGame = function () {
        var _this = this;
        console.log(this.modifiedGameData);
        this._data.modifyGame(this.modifiedGameData).subscribe(function (res) {
            console.log(res);
            _this._router.navigate(['../games']);
    ...
    ModifyComponent.prototype.BackToPrePage = function () {
        this._router.navigate(['../games']);
    };
    ModifyComponent.ctorParameters = function () { return [
        { type: _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(data, _router) {
        this.data = data;
        this._router = _router;
    }
    HomeComponent.prototype.ngOnInit = function () {
    };
    HomeComponent.prototype.toGamePage = function () {
        this._router.navigate(["./games"]);
    };
...
var TokenInterceptorService = /** @class */ (function () {
    ...
    TokenInterceptorService.prototype.intercept = function (req, next) {
        var authService = this.injector.get(_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]);
